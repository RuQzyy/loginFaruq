...
class AddTransactionPage extends StatefulWidget {
  const AddTransactionPage({super.key, required void Function(String type, double amount, String description) onTransactionAdded});
        ...
        builder: (context) => AlertDialog(
          ...
          content: Column(
            ...
            children: [
              ...
              Text('Jumlah: ${_amountController.text}'),
